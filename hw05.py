class VendingMachine:
    ...
    def add_funds(self,amount):
        ...
        if self.remain==0:
            tmp=self.money
            self.money=0
            return 'Inventory empty. Restocking required. Here is your ${0}.'.format(tmp)
        else:return 'Current balance: ${0}'.format(self.money)
    ...
    def vend(self):
        if self.remain==0:
            ...
            tmp=self.money-self.price
            self.money=0
            self.remain-=1
            return 'Here is your {0} and ${1} change.'.format(self.goods,tmp)

    def restock(self,num):
        self.remain+=num
        return 'Current {0} stock: {1}'.format(self.goods,self.remain)
