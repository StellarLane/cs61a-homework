...
def balanced(m):
    ...
    if is_planet(m):return True
        ...
        left_len=length(l)
        right_len=length(r)
        left_weight=total_weight(end(l))
        right_weight=total_weight(end(r))
        return balanced(end(l)) and balanced(end(r)) and left_len*left_weight==right_len*right_weight
    "*** YOUR CODE HERE ***"
...
def replace_leaf(t, find_value, replace_value):
    ...
    """
    if is_leaf(t):
        if label(t)==find_value:return tree(replace_value)
...
def has_path(t, word):
    ...
    if len(word)==1:return label(t)==word
    else:
...
def check_par():
    ...
    True
    """
    r1 = interval(1, 1000) # Replace this line!
    r2 = interval(1, 1000) # Replace this line!
    return r1, r2
